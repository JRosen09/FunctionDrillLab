...
/*
  ...
  nameCheck should check 
  if the name equals 'Steven'. 
...
function faveColorFinder(color) {
  if (color === `red`) {
    ...
    return ` you need to evaluate your favorit color choice`;
  }
}
...
/*
  ...
  if the number is even, return 'That's not odd!'
  Otherwise, return 'That is odd indeed!'
  Outside the function, 
  create a variable called `oddChecker` 
...
/* 
  ...
  If it is, 
  push 'big' as a string to the answers array. 

  If the number is LESS than or EQUAL to 100, 
  push 'small' as a string to the answers array. 
...
/*
  ...
  If the loser string appears in the array, 
  splice it out. 
...
/*
  ...
  Inside the function, 
  convert the email param into a string and trim off any excess whitespace.

  Check to make sure the email contains an '@' symbol.

  If it does, return 'email verified' 
  and if doesn't, 
...
//CODE HERE
function frogbuying (gold){
  return gold / 3

}
let totalFrogs = frogbuying(30)
...
/*
  ...
  In the body of the function, write logic to determine 
...
let arrayIsAscending = acendingarray(sampleArray)
////////////////// PROBLEM 22 ////////////////////
